...
export function OfficeAgentPanel() {
  ...
  const { selectedAgent, setSelectedAgent, agents, agentStates, loading } = useOfficeStore();

  if (pathname !== "/office" || loading || !selectedAgent) return null;
  ...
  }[state.status] ?? { text: "#6b7280", bg: "rgba(107,114,128,0.15)" };

  return (
    <div
      style={{
        position: "fixed",
        // Sits inside content area — respects topbar and statusbar
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between" }}>
        ...
        <button
          ...
          style={{ padding: "8px", borderRadius: "8px", background: "rgba(255,255,255,0.08)", border: "none", color: "#fff", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}
      ...
      <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", padding: "6px 14px", borderRadius: "999px", backgroundColor: statusColor.bg, width: "fit-content" }}>
        ...
        <span style={{ fontFamily: "var(--font-body)", fontSize: "12px", fontWeight: 600, color: statusColor.text, letterSpacing: "1px" }}>
      ...
      <div style={{ borderTop: "1px solid rgba(255,255,255,0.08)", paddingTop: "20px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8px" }}>
          {[
            ...
            <button
              key={label}
              style={{ padding: "10px 12px", borderRadius: "8px", backgroundColor: bg, border: "none", color, fontFamily: "var(--font-body)", fontSize: "13px", cursor: "pointer", transition: "opacity 150ms ease" }}
